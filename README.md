...
- 🧩 **双层屏蔽**：支持在 **楼层（发言内容）** 和 **帖子（主题帖）** 两个层面进行屏蔽  
...
- **屏蔽引用后效果**  
  ![屏蔽引用后效果](images/pb7.png)

---

## 📌 后续更新计划 v2.0 已经进入pre版本状态
1. **关键词屏蔽 (Keyword Blocking)**  
   在面板中增加“屏蔽词”列表（如：不喜欢的 XP、政治、引战）。如果帖子标题或内容包含这些词，直接屏蔽。  

2. **点击查看开关 (Toggle Reveal)**  
   在“替换模式”下，将提示语变成一个可点击的按钮（例如：[已屏蔽用户的发言 - 点击临时查看]），方便临时查看。  
